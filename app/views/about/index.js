          ...
          <Header selectedOption="about" />
            <div className="content">
              <div className="box">
                ...
                <p>Hi! My name is Radosław Lisowski and I am a full stack developer. Don't sweat to much trying to pronounce my name, I know it's hard for an average English speaker. Just call me Rad like everybody else.</p>
                <p>I always had a passion for technology, so I have started studying Computer Science at Wroclaw University of Technology. After graduating I wanted to work with networks and system administration, but I quickly realised that I am much more interested in software development. Because of that I dusted of my programing books and started pursuing that exact career.</p>
